...
%       { \times 2/3 {e16-> e'  b } e,8  e-> e  <e e'>16 b' fis8 g-> gis } 
	 ...
	 \mark \markup { \teeny \bold "Gtr. 2 before Fig. 2" }
          b''16 ( ais b8 ) \staccato g16 ( fis g8 ) \staccato g16 e g g   (e8) d16 dis 
...
%{
     ...
     <ais e>8 
      ...
      \times 2/3 {e b dis}  
      dis g,8. ~ g4
      % incomplete, needs behind-nut bend from g to a
%}
    }
 ...
 { 
   ...
   \times 2/3 { b,16 ais a } g a g e d e d4. b'8
   d16 e d b  d8 a16 a8 g16 \glissando fis a g e ais8 
